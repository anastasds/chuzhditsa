...
— your reader, still \#\# Notes and Sources
...
\textbf{Kafka} — Franz Kafka's written instruction to Max Brod that his manuscripts be burned unread; Brod's refusal preserved \emph{The Trial}, \emph{The Castle}, and \emph{Amerika}, all unfinished.
...
\textbf{Turing} — the halting problem (1936): no general procedure decides, for every program, whether it halts — cited in the treatise as labeled analogy, not theorem-about-diaries.
