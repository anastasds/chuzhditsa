...
"b": dict(adv=595, strokes=[(R,318,183,188),(L,160,190,160,700),(L,160,700,480,700)]),
"v": dict(adv=575, strokes=[(L,160,0,160,700),(R,320,545,163),(R,308,173,178)]),
...
"er": dict(adv=640, strokes=[(L,60,700,240,700),(L,240,700,240,0),(R,378,163,168)]),
"ermal": dict(adv=585, strokes=[(L,190,0,190,700),(R,328,163,168)]),
"yeru": dict(adv=760, strokes=[(L,130,0,130,700),(R,268,163,168),(L,620,0,620,700)]),
...
"nsoft": dict(adv=850, strokes=[(L,160,0,160,700),(L,500,0,500,700),(L,160,350,500,350),(R,635,160,165)]),
"lsoft": dict(adv=940, strokes=[(L,70,0,330,700),(L,330,700,590,0),(L,590,0,590,340),(R,725,160,165)]),
...
LC_CUSTOM = {
"a": dict(adv=640, strokes=[(R,317,243,248),(L,535,10,535,490)]),
...
"b": dict(adv=620, strokes=[(R,315,245,250),(L,95,250,95,700),(L,95,700,400,700)]),
"r": dict(adv=670, strokes=[(L,150,-200,150,500),(R,370,245,250)]),
...
def glyph_contours(gdef, w, dotr, slant, dx=0):
    ...
    for st in gdef["strokes"]:
        ...
        if kind == L:
            ...
            if cy - r <= 60:  # bowls on the baseline get their bottoms pinned
                cy, r = pin_bottom(cy, r, wr)
