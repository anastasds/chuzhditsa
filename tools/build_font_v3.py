...
KERN = {
    "RR": -14, "RF": -6, "FR": -6, "FF": 0, "DD": -42, "DR": -20, "RD": -20,
    "DF": -14, "FD": -14, "TT": -85, "TR": -60, "RT": -12, "TF": -35, "FT": -4, "DT": -40,
    "TD": -16, "RA": -22, "FA": -16, "DA": -38, "TA": -95,
...
def glyph_set(p):
    ...
    G["б"] = dict(adv=420, s=[L((40, 0), (40, 500)), L((40, 500), (360, 500)),
    ...
    G["һ"] = dict(adv=500, s=[L((40, 0), (40, 640)), A(250, 290, 210, 0, 180),
                              L((460, 0), (460, 290))])
    ...
    C["С"] = dict(adv=555, s=[E(320, 350, R7, R7v, ap, 360 - ap)]); CAP_OF["С"] = "с"
    C["Ҫ"] = dict(adv=555, s=[E(320, 350, R7, R7v, ap, 360 - ap),
