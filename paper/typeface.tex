...
kern classes & $-$35 \ldots $-$70 & mark anchors & bbox top $+$40; bottom floor $-$60 \\
...
\caption{Chuzhditsa v2.4: the Slavic base, the designed extension inventory, and the four styles — every glyph, joint, terminal, and correction in this specimen is the output of the seven hundred lines this paper described.}\label{fig:specimen}
\end{figure}
