...
\bottomrule
\end{tabular}
\caption{Instrumented small-size check, FreeType rendering, 50\% ink threshold. Mark columns: ink pixels above the base letter's top. Pair columns: symmetric difference of ink in pixels. The 10\,px row records the face's honest floor.}
\label{tab:sizes}
\end{table}
\begin{figure}[ht]\centering
...
\caption{Chuzhditsa v2.3: the Slavic base, the designed extension inventory, and the four styles — every glyph, joint, terminal, and correction in this specimen is the output of the six hundred lines this paper described.}\label{fig:specimen}
\end{figure}
