...
\cz{а̨ ӧ̨} & V + U+0328 & \ph{ɑ̃ ɐ̃ œ̃} & vowel + yus tail & derived by rule \\
\cz{Ӣӣ Ӯӯ} & U+04E2/3, EE/EF & \ph{iː uː} & vowel + macron & import: Tajik (ӯ is \ph{ɵ} there) \\
...
Bengali & Standard & \cz{т̢ д̢ р̢ ң ӓ} \cz{◌ʰ ◌ʱ} & \ph{ɔ}$\rightarrow$\cz{о} & — \\
...
Polish & Standard & \cz{ѫ ѧ ѩ ў ы} & \ph{ɕ}$\rightarrow$\cz{сь}; \ph{ʂ}$\rightarrow$\cz{ш}; \ph{t͡ʂ}/\ph{t͡ɕ}$\rightarrow$\cz{ч} & — \\
