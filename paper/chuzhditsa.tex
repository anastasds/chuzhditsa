...
\author{Anastas Stoyanovsky\thanks{Fonts, build toolchain, and the twenty-language audit are available in the accompanying repository (\texttt{github.com/anastasds/chuzhditsa}); the typeface used for all object-language examples in this manuscript is the system being described.}\\[3pt] {\normalsize Unaffiliated \quad \texttt{anastas@stoyanovs.ky}}}
\date{}

\begin{document}
\special{pdf:docinfo << /Title (Chuzhditsa: a phonological citation register for Cyrillic) /Author (Anastas Stoyanovsky) >>}
\maketitle
