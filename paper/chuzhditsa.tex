...
\author{Anastas Stoyanovsky\thanks{Fonts, build toolchain, and the twenty-language audit are available in the accompanying repository; the typeface used for all object-language examples in this manuscript is the system being described. Construction and drafting were performed by a language model under the author's direction; the author deliberately supplied criticism without solutions, as a test of the model's capacity for skilled work he could not himself perform — a methodological choice documented in a companion process study.}}
\date{}
